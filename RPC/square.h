...
#define SQRPROC 2
extern  square_out * sqrproc_1(square_in *, CLIENT *);
extern  square_out * sqrproc_1_svc(square_in *, struct svc_req *);
...
#define SQRPROC 2
extern  square_out * sqrproc_1();
extern  square_out * sqrproc_1_svc();
